...
- **Don't ship the HTML shell into `main`.** The page is optimised for being clicked through by hand. The logic module behind it is the bit that lands on `main`; the shell lives on the throwaway branch.
