...
The diagrams carry the weight. Prose is sparse, plain, and uses the `codebase-design` glossary terms without ceremony.
...
Plain English, concise — but the architectural nouns and verbs come straight from the `codebase-design` glossary. Concision is not an excuse to drift.
